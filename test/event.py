...
class TestEvent(unittest.TestCase):
    ...
    def test_event_channel(self):
        channel: EventChannel = EventChannelManager().perform_event("test_channel", "test_event", "it‘s a test event")
        channel: EventChannel = EventChannelManager().perform_event("test_channel2", "test_event2", "it‘s a test event2")
